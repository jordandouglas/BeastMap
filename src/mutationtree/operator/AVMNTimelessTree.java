...
/**
 * This operator differs from the standard AVMN in beast core by allowing timeless trees
...
public class AVMNTimelessTree extends KernelOperator {
    ...
    public class CompoundParameterHelper {
        ...
        public int setValue(final int param, final double value) throws Exception {
            ...
            if (para instanceof RealParameter) {
            	...
            	// This is where the class differs from the standard AVMN
            	Tree tree = (Tree) para;
            	tree.scale(scale);
            	if (tree instanceof TimelessTree) {
            		return tree.getNodeCount()-1; // Branch count
            	}else {
            		return tree.getInternalNodeCount(); // Internal node count
            	}
