...
# Validation of stochastic mapping and gamma-length tree prior using simulation studies 
...
1. Simulate 100 gamma-length trees and then simulate 100 datasets under these trees. The substitution histories of these trees will be recorded.  
